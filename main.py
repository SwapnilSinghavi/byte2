...
API_KEY = 'AIzaSyCu879veZIDHtXeJqPr6d6ZCW2uBYasdos'
...
TABLE_ID = '1idTJ4hRvpgnFcVvGHvKV7SRxypEoRC4i9emX9VRF'#'1VlPiBCkYt_Vio-JT3UwM-U__APurJvPb6ZEJPg'

# This is the default columns for the query
query_cols = []
query_values = ['5000000'] #Change to be the value(s) you're querying in the column you've specified
...
def make_query(cols, values, limit):
    ...
    query = "SELECT " + string_cols + " FROM " + TABLE_ID + " WHERE Recreational_Visits > '" + string_values + "'"
...
def index():
    ...
    res = get_all_data(make_query([], query_values, 7)) #5 is our limit we're passing in
